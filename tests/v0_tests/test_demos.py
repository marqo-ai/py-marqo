...
class TestDemo(MarqoTestCase):
    ...
    def test_demo(self):
        ...
        test_index_name = self.create_test_index("cool-index-1")
    ...
    def test_readme_example(self):
        ...
        test_index_name = self.create_test_index("my-first-index")
    ...
    def test_readme_example_weighted_query(self):
        import marqo
        mq = marqo.Client(**self.client_settings)
        test_index_name = self.create_test_index("my-weighted-query-index")
        mq.index(test_index_name).add_documents([
                {
                    "Title": "Smartphone",
