...
class CreateIndexSettings:
    ...
    def __init__(self, treat_urls_and_pointers_as_images, model, normalize_embeddings,
        ...
        self.not_compatible_with_settings_dict_params_specified = False
    ...
    def _set_value(self, value, parameter_name):
        if value is not None:
            ...
            if parameter_name not in params_that_can_be_specified_with_settings_dict:
                self.not_compatible_with_settings_dict_params_specified = True
            if "settings_dict" in self.specified_values and self.not_compatible_with_settings_dict_params_specified:
